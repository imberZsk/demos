...
export const addMaterialAndAction = (gltf, name, refRenderer, options) => {
...
// 默认使用dds加载器加载dds纹理
var Tire_A02_s3tc = LoadTextureCorrected(mDDSLoader, 'data/lynkco09/texture/Tire_A02-dxt.dds')
var Tire_N02_s3tc = LoadTextureCorrected(mDDSLoader, 'data/lynkco09/texture/Tire_N02-dxt.dds')
var Tire_A02_pvr = LoadTextureCorrected(mKTXLoader, 'data/lynkco09/texture/Tire_A02-pvr.ktx')
var Tire_N02_pvr = LoadTextureCorrected(mKTXLoader, 'data/lynkco09/texture/Tire_N02-pvr.ktx')
var Tire_A02_etc1 = LoadTextureCorrected(mKTXLoader, 'data/lynkco09/texture/Tire_A02-etc1.ktx')
var Tire_N02_etc1 = LoadTextureCorrected(mKTXLoader, 'data/lynkco09/texture/Tire_N02-etc1.ktx')

// 判断用户是移动端还是PC端
// 如果是移动端，用ktx加载器加载ktx纹理
// 如果是PC端， 用dds加载器加载dds纹理
// let mobileEnd = [
//   'Android',
//   'iPhone',
//   'SymbianOS',
...
//   'iPod'
// ]
// for (let i = 0; i < mobileEnd.length; i++) {
//   if (navigator.userAgent.includes(mobileEnd[i])) {
//     console.log('移动端', navigator.userAgent)
//     // 判断到如果是移动端，就使用 ktxLoader 加载 ktx 格式
//   }
// }
...
// )
var Phev_Hub06_AO = LoadTextureCorrected(mTextureLoader, 'data/lynkco09/texture/Phev_Hub06_AO.jpg')
var Alpha01 = LoadTextureCorrected(mDDSLoader, 'data/lynkco09/texture/Alpha01-dxt.dds')
